...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-[calc(2.75rem+2px)] items-center justify-center rounded-lg gap-x-1",
      className
    )}
    {...props}
  />

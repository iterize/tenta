...
You can explore the `configuration` and `log` tables in the same way. Please refer to the [database schema](https://github.com/iterize/tenta/blob/main/server/schema.sql) for exact details on the available columns.
